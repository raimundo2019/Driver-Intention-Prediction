...
RNN simple para 13 caracteristicas con entrada temporal real 20 x 13.
...
def guardar_grafico_entrenamiento(history, out_prefix, epochs_configuradas, patience):
    ...
    fig.suptitle(
        f"RNN 13 caracteristicas - Early Stopping "
...
evaluate_and_export(
    "RNN 13 caracteristicas con Early Stopping",
    OUT_PREFIX,
    y_test,
    y_prob,
    history=history,
