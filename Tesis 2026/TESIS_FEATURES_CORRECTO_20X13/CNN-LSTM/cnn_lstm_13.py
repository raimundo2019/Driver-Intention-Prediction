...
# -*- coding: utf-8 -*-
"""
cnn_lstm_13_earlystopping_train_val.py

Modelo hibrido CNN-LSTM para 13 caracteristicas con entrada temporal real 20 x 13.
...
def guardar_grafico_entrenamiento(history, out_prefix, epochs_configuradas, patience):
    ...
    fig.suptitle(
        f"CNN-LSTM 13 caracteristicas - Early Stopping "
...
evaluate_and_export(
    "CNN-LSTM 13 caracteristicas con Early Stopping",
    OUT_PREFIX,
    y_test,
    y_prob,
    history=history,
