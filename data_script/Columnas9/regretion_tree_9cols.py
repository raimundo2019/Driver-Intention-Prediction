# ===========================================
# Regr. Logística y Árbol de Decisión (9 cols)
# ===========================================
...
# Ajustar dimensiones
n_samples = Y.shape[0]
n_features = 9 * 20   # 20 pasos temporales * 9 features
n_classes = 3
...
guardar_matriz(y_true, y_pred_log,
               "confusion_logistic_9cols",
               "Matriz de confusión - Regresión Logística (9 columnas)")
guardar_matriz(y_true, y_pred_tree,
               "confusion_tree_9cols",
               "Matriz de confusión - Árbol de Decisión (9 columnas)")
