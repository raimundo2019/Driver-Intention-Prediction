# =====================================================
# Entrenamiento y evaluación LSTM (10 columnas)
# =====================================================
...
model.save("lstm_10cols_model.h5")
...
plt.xlabel("Epoch"); plt.ylabel("Accuracy"); plt.title("Curva de entrenamiento LSTM (10 cols)")
plt.legend(["train","val"]); plt.tight_layout()
plt.savefig("training_curves_lstm_10cols.png", dpi=300, bbox_inches="tight"); plt.close()
...
plt.title("Matriz de Confusión - LSTM (10 columnas)")
plt.tight_layout()
plt.savefig("confusion_lstm_10cols.png", dpi=300, bbox_inches="tight")
plt.close()

pd.DataFrame(cm, columns=["Pred_GR","Pred_SD","Pred_GI"],
             index=["True_GR","True_SD","True_GI"]).to_csv("confusion_lstm_10cols.csv", index=True)
pd.DataFrame(cm_norm, columns=["Pred_GR","Pred_SD","Pred_GI"],
             index=["True_GR","True_SD","True_GI"]).to_csv("confusion_lstm_10cols_normalized.csv", index=True)

print("\nSalidas LSTM (10 cols):")
print(" - lstm_10cols_model.h5")
print(" - training_curves_lstm_10cols.png")
print(" - confusion_lstm_10cols.png")
print(" - confusion_lstm_10cols.csv")
print(" - confusion_lstm_10cols_normalized.csv")
