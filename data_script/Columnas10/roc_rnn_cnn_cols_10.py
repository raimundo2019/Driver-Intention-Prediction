# =====================================================
# Entrenamiento + ROC + Matriz de Confusión (10 columnas)
# =====================================================
...
X = np.reshape(X, (n_samples, 20, 10))
...
# ------------------------------
model = Sequential([
    Conv1D(64, 3, activation='relu', input_shape=(20, 10)),
    Dropout(0.3),
...
print("Modelo CNN/RNN (10 columnas) guardado como cnn_rnn_10cols_model.h5")
...
plt.xlabel('FPR')
plt.ylabel('TPR')
plt.title('Curvas ROC - CNN/RNN (10 columnas)')
plt.legend(loc='lower right')
plt.savefig("roc_cnn_rnn_10cols.png", dpi=300, bbox_inches='tight')
plt.close()
